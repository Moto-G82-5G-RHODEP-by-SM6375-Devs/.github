...
Founded By [@AnandSuresh02](https://github.com/AnandSuresh02) and maintained by [@vitor_legendary](https://github.com/victorlima-legendary), feel free to contribute.
<!--
...
```
Or (For Unofficial Files: Contain Dolby AOSP):
```
git clone https://github.com/Moto-G82-5G-RHODEP-by-SM6375-Devs/android_hardware_motorola.git hardware/motorola
```
...
```
git clone https://github.com/Moto-G82-5G-RHODEP-by-SM6375-Devs/android_vendor_motorola_rhodep.git vendor/motorola/rhodep
```

```
git clone https://github.com/Moto-G82-5G-RHODEP-by-SM6375-Devs/android_vendor_motorola_sm6375-common.git vendor/motorola/sm6375-common
```
### Note:
